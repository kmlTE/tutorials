...
echo $filename
yes "0" | head -n $(( $iperf_period + 1 )) | nl -b a -v 0 | tee $filename
cat ${algo_dir}/${next_dir}/raw/udp/h7-iperf.csv | grep -v "0.0-${iperf_period}" | grep ",10.0.1.1," | cut -d ',' -f 13 | nl -b a -i 1 -v $(( $iperf_period + 1 )) | tee -a $filename
yes "0" | head -n $iperf_period | nl -b a -v $(( $iperf_period * 2 + 1 )) | tee -a $filename
...
echo $filename
yes "0" | head -n $(( $iperf_period + 1 )) | nl -b a -v 0 | tee $filename
cat ${algo_dir}/${next_dir}/raw/udp/h7-iperf.csv | grep -v "0.0-${iperf_period}" | grep ",10.0.1.1," | cut -d ',' -f 10 | nl -b a -i 1 -v $(( $iperf_period + 1 )) | tee -a $filename
yes "0" | head -n $iperf_period | nl -b a -v $(( $iperf_period * 2 + 1 )) | tee -a $filename
...
echo $filename
yes "0" | head -n $(( $iperf_period + 1 )) | nl -b a -v 0 | tee $filename
cat ${algo_dir}/${next_dir}/raw/udp/h7-iperf.csv | grep -v "0.0-${iperf_period}" | grep ",10.0.1.1," | cut -d ',' -f 15 | nl -b a -i 1 -v $(( $iperf_period + 1 )) | tee -a $filename
yes "0" | head -n $iperf_period | nl -b a -v $(( $iperf_period * 2 + 1 )) | tee -a $filename
